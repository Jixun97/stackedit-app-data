...
- 系统哈密顿量：
$H/\hbar = \frac{w_1}{2} \sigma_{z,1}+\frac{w_2}{2} \sigma_{z,2}+J(\sigma_{+,1}+\sigma_{-,2})+\Sigma_m[w_{m,1}(a^{\dagger}_{m,1}a_{m,1}+\frac{1}{2})+g_{m,1}(a^{\dagger}_{m,1} \sigma_{-,1}+a_{m,1}\sigma_{+,1})+\Sigma_n[w_{n,2}(a^{\dagger}_{n,1}a_{m,1}+\frac{1}{2})+g_{m,1}(a^{\dagger}_{m,1} \sigma_{-,1}+a_{m,1}\sigma_{+,1})$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5NTMzNzMxMiwtMjYyOTkzMzgsLTg5ND
M3MjEsLTY3NDk2MzMyOCwzMjI3NTMwMzgsMTgxOTU1NjAsLTE3
ODYzMTMwMSwtMTI5MTA2ODUwNCwxNDgyNDg1NjI2LDUxMDc4OT
gwOSwtOTk4NTg2MjA1LDE2Mjg5MjY3NTAsMTg0MTcxNTM3MSwt
MTEzMjA2NzU5OCwtMTE5MjE5MDg4OSwyNzYzMDg1NzFdfQ==
-->