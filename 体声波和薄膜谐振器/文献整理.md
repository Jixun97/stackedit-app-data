...
其中，$w_1$和$w_2$是Qubit的频率,$J$是Qubit-Qubit的耦合,$w_{m,1}$和$w_{n,2}$分别是HBAR相对于Qubit的模式频率,$g_{m,1}$和$g_{n,2}$表示HBAR模式频率的耦合,
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNDIwNTY4ODUsNDAzNzA3ODM2LC0yMD
