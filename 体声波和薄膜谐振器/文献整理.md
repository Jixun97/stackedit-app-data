...
- $\kappa_o$表示光子耗散,  $\kappa_e$是微波耗散,$\gamma_m$是机械振子耗散,$g_{om}$表示光机耦合强度系数,$g_{em}$表示电机耦合强度系数.$\eta$是传导效率.$n_{add,o}$表示光学输入噪声,$n_{add,e}$表示微波输入噪声.
- 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg2OTU2OTQwMiw1MTA3ODk4MDksLTk5OD
