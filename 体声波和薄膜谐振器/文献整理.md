...
- **原理：** 由Qubit边带介导的两种机械模式 ***b*** 和 ***c*** 之间的分束器耦合。 驱动器之间的频率差由 $\Delta_{21}$ 给出，而所获取的两个感兴趣的相邻模式之间的唯一间距由 Δ 给出。
- 在玻色子模式的大希尔伯特空间中编码和处理量子信息方面取得了重要进展。 机械谐振器为此目的具有几个实际优势，因为它们将许多高质量因子模式限制在一个小体积中，并且可以轻松地与不同的量子系统集成。 然而，在不同机械模式之间创建可用于模拟量子门的直接相互作用具有挑战性。 
- 该研究中，高泛音体声波谐振器的几种机械模式之间的原位可调谐分束器型相互作用。 工程相互作用是由参数驱动的超导跨量子位介导的，证明了它可以针对声子模式的耦合对或三重态进行定制。 此外，利用这种相互作用来证明声子之间的红欧曼德尔效应。 未来有望用于量子存储器和量子模拟平台。

## 关于体声波源的研究

**体声波谐振器：**
- 目前的体声波声子源的器件技术都比较成熟，国内外均有不错的研究成果。
- 固态机械谐振器已成为演示涉及真正宏观数量的粒子的系统非经典行为的平台。 在这里，我们在机械谐振器中进行了迄今为止最宏观的量子测试，通过排除微克质量尺度的经典描述来探讨量子力学的有效性。 这是通过直接测量高泛音体声波谐振器模式的维格纳函数来完成的，监测负性在数十微秒内的逐渐衰减。 虽然所获得的 μ 1/4 11.3 宏观性与最先进的原子干涉仪相当，但模式几何和相干时间的未来改进可以在前所未有的尺度上测试量子叠加原理，并对自发塌缩模型设置更严格的界限。
**品质因子：**
- 体声波源材料，结构。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE2MjUwNTIwNCwtMzk5Mzg1NzA1LDQ0MD
U1MDExNSwtOTI2MTIxNDMwLC0xMjI2NjQzOTA2LDMxNTkzNjAw
NCwzNDExNDU2MTEsMTkwMDM3Nzc3MiwtMTM0MjkxNTI1MSwxMD
k4NzM4Nzg4LDExMDYwNzgxMTQsLTExNzE3OTI4MjMsLTkxNDM3
MDI5LC0yMjY3OTY1ODEsMTc4MTg5ODk5LDYwNDA0OTMwMSw1OD
YxMTA4ODksLTEyMzk0Nzg5MzIsNDAzNzA3ODM2LC0yMDE0ODg3
MjU0XX0=
-->