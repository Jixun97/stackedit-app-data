...
- 系统哈密顿量：
$H/\hbar &= \frac{w_1}{2} \sigma_{z,1}+\frac{w_2}{2} \sigma_{z,2}+J(\sigma_{+,1}+\sigma_{-,2})+\Sigma_m[w_{m,1}(a^{\dagger}_{m,1}a_{m,1}+\frac{1}{2})+g_{m,1}(a^{\dagger}_{m,1} \sigma_{-,1}+a_{m,1}\sigma_{+,1})\\+$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUyNDc2MTk5MCwtMjYyOTkzMzgsLTg5ND
